...
@Component({
  ...
  styles: [`
    ...
    .hero-badge {
      ...
      padding:0.4rem 1rem;
      border:1px solid rgba(30,64,175,0.3); border-radius:20px;
    ...
    .line1 { color:#1F2937; }
    .line2 { color:var(--neon); text-shadow:0 0 40px var(--neon),0 0 80px rgba(30,64,175,0.2); }
    .line3 { color:rgba(31,41,55,0.6); font-size:0.5em; letter-spacing:8px; display:block; margin-top:0.3em; }
    .hero-desc { font-size:1.15rem; line-height:1.8; color:rgba(31,41,55,0.7); max-width:500px; margin-bottom:2.5rem; font-weight:300; animation:fadeUp 0.8s 0.2s ease both; }
    ...
    @keyframes jointPulse { 0%,100%{filter:drop-shadow(0 0 6px #1E40AF)} 50%{filter:drop-shadow(0 0 16px #1E40AF)} }
    ...
    .stat-item:hover { background:rgba(30,64,175,0.08); transform:translateY(-2px); }
    .stat-num { font-family:'Orbitron',monospace; font-size:2.5rem; font-weight:900; color:var(--neon); text-shadow:none; display:block; }
    .stat-label { font-size:0.75rem; letter-spacing:3px; text-transform:uppercase; color:rgba(31,41,55,0.6); margin-top:0.3rem; }
    ...
    .section-heading { font-family:'Orbitron',monospace; font-size:clamp(1.5rem,3vw,2.5rem); color:#1F2937; margin-bottom:3rem; }
    ...
    .feature-card:hover { background:rgba(30,64,175,0.04); }
    .feature-icon { font-size:2rem; margin-bottom:1.5rem; display:block; }
    .feature-card h3 { font-family:'Orbitron',monospace; font-size:0.85rem; letter-spacing:2px; color:#1F2937; margin-bottom:0.8rem; }
    .feature-card p { font-size:0.9rem; color:rgba(31,41,55,0.65); line-height:1.7; font-weight:300; }

    .cta-section { position:relative; z-index:1; text-align:center; padding:6rem 3rem; background:linear-gradient(180deg,transparent,rgba(30,64,175,0.04),transparent); border-top:1px solid var(--border); border-bottom:1px solid var(--border); }
    .cta-section h2 { font-family:'Orbitron',monospace; font-size:clamp(1.8rem,4vw,3rem); color:#1F2937; margin-bottom:1rem; }
    .cta-section p { color:rgba(31,41,55,0.6); margin-bottom:2.5rem; font-size:1.1rem; }
    .cta-btns { display:flex; gap:1rem; justify-content:center; }

    footer { position:relative; z-index:1; text-align:center; padding:2rem; font-size:0.8rem; color:rgb(1, 1, 2); letter-spacing:2px; border-top:1px solid var(--border); }
  `],
  template: `
    ...
    <nav>
      <div style="display:flex; align-items:center; gap:1rem;">
        <img src="assets/icons/logo.png" alt="Starz Electronics" style="height:40px; width:auto;">
          ...
          <svg class="robot-svg" viewBox="0 0 380 420">
            <defs>
              ...
              <linearGradient id="segGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="100%" style="stop-color:#1E20DC;stop-opacity:0.4"/>
              </linearGradient>
            </defs>
            <rect x="120" y="370" width="140" height="20" rx="4" fill="#0a2a26" stroke="#1E40AF" stroke-width="1.5" filter="url(#glow)"/>
            <rect x="145" y="355" width="90"  height="20" rx="3" fill="#0d332e" stroke="#1E40AF" stroke-width="1"/>
            <circle class="joint" cx="190" cy="350" r="16" fill="#041a17" stroke="#1E40AF" stroke-width="2" filter="url(#glow)"/>
            <circle cx="190" cy="350" r="8" fill="#1E40AF" opacity="0.4"/>
            <text x="240" y="365" fill="#1E40AF" font-size="10" font-family="Orbitron" opacity="0.7">BASE</text>
            <g class="arm-segment" style="transform-origin:190px 350px">
              <rect x="180" y="245" width="20" height="110" rx="6" fill="url(#segGrad)" stroke="#1E40AF" stroke-width="1.5" filter="url(#glow)"/>
              <circle class="joint" cx="190" cy="250" r="16" fill="#041a17" stroke="#1E40AF" stroke-width="2" filter="url(#glow)"/>
              <circle cx="190" cy="250" r="8" fill="#1E40AF" opacity="0.4"/>
              <text x="215" y="300" fill="#1E40AF" font-size="9" font-family="Orbitron" opacity="0.7">SHOULDER</text>
            </g>
            <g style="transform-origin:190px 250px;transform:rotate(-15deg)">
              <rect x="180" y="155" width="20" height="100" rx="6" fill="url(#segGrad)" stroke="#1E40AF" stroke-width="1.5" filter="url(#glow)"/>
              <circle class="joint" cx="190" cy="160" r="14" fill="#041a17" stroke="#1E40AF" stroke-width="2" filter="url(#glow)"/>
              <circle cx="190" cy="160" r="6" fill="#1E40AF" opacity="0.4"/>
              <text x="215" y="200" fill="#1E40AF" font-size="9" font-family="Orbitron" opacity="0.7">ELBOW</text>
            </g>
            <g style="transform-origin:188px 160px;transform:rotate(-10deg)">
              <rect x="182" y="100" width="16" height="65" rx="4" fill="#0d332e" stroke="#1E40AF" stroke-width="1.5"/>
              <rect x="175" y="85"  width="10" height="28" rx="3" fill="#1E40AF" opacity="0.6"/>
              <rect x="195" y="85"  width="10" height="28" rx="3" fill="#1E40AF" opacity="0.6"/>
              <rect x="183" y="80"  width="14" height="14" rx="2" fill="#041a17" stroke="#DC2626" stroke-width="1.5"/>
              <text x="215" y="120" fill="#DC2626" font-size="9" font-family="Orbitron" opacity="0.9">GRIPPER</text>
            </g>
            <text x="20" y="30"  fill="#1E40AF" font-size="9" font-family="Rajdhani" opacity="0.5">BASE: 90°</text>
            <text x="20" y="45"  fill="#1E40AF" font-size="9" font-family="Rajdhani" opacity="0.5">SHOULDER: 90°</text>
            <text x="20" y="60"  fill="#1E40AF" font-size="9" font-family="Rajdhani" opacity="0.5">ELBOW: 90°</text>
            <text x="20" y="75"  fill="#DC2626" font-size="9" font-family="Rajdhani" opacity="0.5">GRIPPER: 0°</text>
            <path d="M10 10 L40 10 L40 12 L12 12 L12 40 L10 40 Z"    fill="#1E40AF" opacity="0.3"/>
            <path d="M370 10 L340 10 L340 12 L368 12 L368 40 L370 40 Z"  fill="#1E40AF" opacity="0.3"/>
            <path d="M10 410 L40 410 L40 408 L12 408 L12 380 L10 380 Z"  fill="#1E40AF" opacity="0.3"/>
            <path d="M370 410 L340 410 L340 408 L368 408 L368 380 L370 380 Z" fill="#1E40AF" opacity="0.3"/>
          </svg>
        </div>
      </div>
    </section>
    ...
    <footer>ROBOT ARM CONTROL SYSTEM &nbsp;|&nbsp; 4DOF ROBOT ARM INTERFACE &nbsp;|&nbsp; © 2026</footer>
  `
})
